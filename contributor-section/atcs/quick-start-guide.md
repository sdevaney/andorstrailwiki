...
1. **ATCS Installation**: Download and install ATCS from the official forums
2. **Game Source Code**: Download the complete Andor's Trail source code
3. **Tiled Map Editor**: Install for map creation (optional but recommended)
...
3. Fill in the basic information:
   ...
   * **Category**: Select `weapon_sword` from dropdown
...
1. Create NPC with appropriate name and icon
...
1. Right-click **Dialogues** in project tree
...
5. Configure shop list if creating a trader

### Creating Quests <a href="#creating-quests" id="creating-quests"></a>

### Basic Fetch Quest

1. Right-click **Quests** in project tree
2. Create new quest with ID: `herb_collection`
3. Set basic info:
...
2. Reference scripts in item or NPC JSON
...
2. **Discord**: Real-time assistance from developers and community
...
2. **Export Package**: Create clean ATCS export
3. **Document Changes**: List new content and features
4. **Submit to Forums**: Post with detailed description
